...
function createNewsServiceSpy() {
  return jasmine.createSpyObj('NewsService', ['getNews']);
}
...
describe('BooksComponent', () => {
  ...
  beforeEach(async(() => {
     ...
     mockNewsService = createNewsServiceSpy();
  ...
  it('switchPage() should navigate to all pages', inject([BooksService, DataContainerService],
    (books: BooksService, dataCS: DataContainerService) => {
